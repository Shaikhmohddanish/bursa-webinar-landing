...
export default function BursaWebinarLanding() {
  ...
  // Get default date (upcoming Sunday)
  ...
  useEffect(() => {
    const fetchWebinarDate = async () => {
      try {
        ...
        console.error("Failed to fetch webinar date:", error)
        // Set default date if fetch fails
        setWebinarDate(defaultDate)
      } finally {
        setIsDateLoaded(true)
      }
    ...
    <div className="min-h-screen bg-background overflow-x-hidden w-full">
      ...
      <section className="relative bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-4xl mx-auto leading-relaxed">
            ...
            only <span className="font-black text-3xl text-red-600 bg-yellow-200 px-2 py-1 rounded-lg">RM19</span>
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-12 max-w-5xl mx-auto px-2">
            <div className="bg-white p-6 rounded-2xl border-2 border-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 font-medium">
                {!isDateLoaded ? (
                  <span className="inline-block h-5 w-24 bg-gray-200 animate-pulse rounded"></span>
                ) : (
                  webinarDate
                )}
              </p>
      ...
      <section className="py-16 px-4 bg-card">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-background p-8 rounded-lg border mb-8">
            ...
            <p className="text-4xl font-bold text-muted-foreground line-through mb-4">RM199</p>
            <p className="text-lg text-muted-foreground mb-4">Special Today Only:</p>
            <p className="text-6xl font-bold text-primary mb-6">RM19</p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <p className="text-lg leading-relaxed">
                For just RM19, you'll gain access to professional trading strategies that have helped thousands of
            ...
            <div className="bg-teal-800 p-8 rounded-lg">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {!isDateLoaded ? (
                    <span className="inline-block h-5 w-24 bg-teal-700 animate-pulse rounded"></span>
                  ) : (
                    `${webinarDate} 2025`
                  )}
                </div>
                ...
                <div>
                  <span className="font-semibold">Investment:</span> RM19 only
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-4 border-red-500 shadow-2xl z-50 px-2 sm:px-4 py-3 sm:py-4 w-full">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 sm:gap-4 pb-1">
          ...
          >
            <span className="relative z-10">Join Now for RM19!</span>
          </Button>
        </div>
      </div>
